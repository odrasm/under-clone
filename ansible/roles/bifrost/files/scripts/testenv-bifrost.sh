...
docker exec -it bifrost /bifrost/bifrost-cli --debug testenv --count 1 --disk 3 --memory 1024 --inventory /bifrost/testenv.yml -o /bifrost/testenv.json
docker exec -it bifrost /bifrost/bifrost-cli --debug install --hardware-types staging-libvirt,ipmi --testenv
